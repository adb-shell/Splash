...
class BottomTabAdapter(private val photolist:ArrayList<Photos>): RecyclerView.Adapter<BottomTabAdapter.BottomViewHolder>() {

    override fun onCreateViewHolder(parent: ViewGroup, viewtype: Int): BottomTabAdapter.BottomViewHolder {
